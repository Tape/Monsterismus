...
public class Monsterismus extends PApplet
{
  ...
  public void mouseDragged(MouseEvent $event)  { Game.handleMouseEvent($event); }
  public void mouseMoved(MouseEvent $event)    { Game.handleMouseEvent($event); }
  public void mousePressed(MouseEvent $event)  { Game.handleMouseEvent($event); }
  public void mouseReleased(MouseEvent $event) { Game.handleMouseEvent($event); }

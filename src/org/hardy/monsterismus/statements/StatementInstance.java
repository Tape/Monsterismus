...
public abstract class StatementInstance implements Drawable
{
  ...
  /**
   * Creates a new StatementInstance and sets the absolute position
   * to 0, 0.
   */
  ...
  /**
   * Get the StatementInstance under the given absolute coordinates. This is handy
  ...
  /**
   * Checks if the statement has completed its action or animation. It is important
   * to note that this will return true if the instance has never been executed.
   * @return true if the animation is complete, false otherwise.
   */
  public abstract boolean isDone();
  /**
   * Checks if the statement has been executed. This is useful for checking if the
